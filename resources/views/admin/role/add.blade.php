                    ...
                    <div class="card my-4 border">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="checkbox" class="permission" value="3" name="permission_id[]"
                                        id="post.edit">
                                    <label for="post.edit">Edit Post</label>
                                </div>
                                <div class="col-md-3">
                                    <input type="checkbox" class="permission" value="4" name="permission_id[]"
                                        id="post.delete">
                                    <label for="post.delete">Delete Post</label>
                                </div>
                                <div class="col-md-3">
                                    <input type="checkbox" class="permission" value="5" name="permission_id[]"
                                        id="post.list">
