...
@section('content')
            ...
            <div class="card-body">
                <form action="{{ url('admin/product/store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="desc" class="form-control ckeditor" id="intro" cols="30" rows="5">{{ old('desc') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="intro">Product Detail</label>
                        <textarea name="detail" class="form-control ckeditor" id="intro" cols="30" rows="5">{{ old(key: 'detail') }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="uploaded_media" id="uploaded_media" value="{{ old('uploaded_media') }}">
                        <div class="btn_upload">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="warehouse_status" id="in-stock"
                                value="In Stock" {{ old('warehouse_status', 'In Stock') == 'In Stock' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="warehouse_status" id="out-of-stock"
                                value="Out of Stock"
                                {{ old('warehouse_status', 'In Stock') == 'Out of Stock' ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="privacy" id="public" value="public"
                                {{ old('privacy', 'private') == 'public' ? 'checked' : '' }}>
                                    ...
                                    @else
                                        <div class="form-checkbox cat-child" data-id="{{ $filter->id }}"
                                            ...
                                            <input type="checkbox" name="sidebar[]" value="{{ $filter->id }}"
                                                ...
                                                {{ is_array(old('sidebar')) && in_array($filter->id, old('sidebar')) ? 'checked' : '' }}>
                                            <label for="sidebar-{{ $filter->id }}"
    ...
    <script>
        ...
        let oldSidebar = @json(old('sidebar', []));
