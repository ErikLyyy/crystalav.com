    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                <h5 class="m-0 ">List menu <a href="{{ url('admin/menu/add') }}"
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('admin/menu/action') }}" method="GET">
                    <div class="analytic">
                        <a href="{{ url('admin/menu') }}" class="text-primary">All<span
                                class="text-muted">({{ $countItem }})</span></a>
                        <a href="{{ url('admin/menu?status=trash') }}" class="text-primary">
                    ...
                    <table class="table table-striped table-checkall">
                        ...
                        <tbody>
                            ...
                            @foreach ($list_menu as $menu)
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="checkItem[]" value="{{ $menu->id }}">
                                    </td>
                                    <td scope="row">{{ $t }}</td>
                                    ...
                                    <td style="display: flex; justify-content: space-between;">
                                        ...
                                        <div class="action-wp">
                                            @if ($trash == true)
                                                <a href="{{ url('admin/menu/restore/' . $menu->id) }}" class="action"
                                                    title="Restore">
                                            ...
                                            @endif
                                            <a href="{{ url('admin/menu/edit/' . $menu->id) }}" class="action"
                                                title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="20px"
                                                    viewBox="0 -960 960 960" width="20px" fill="#000">
                                                    <path
                                            ...
                                            @if ($trash == true)
                                                <a href="{{ url('admin/menu/forceDelete/' . $menu->id) }}" class="action"
                                            ...
                                            @else
                                                <a href="{{ url('admin/menu/delete/' . $menu->id) }}" class="action"
                                                    title="Delete" style="margin-right: 20px">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="20px"
                                                        viewBox="0 -960 960 960" width="20px" fill="#000">
                                                        <path
