    ...
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('admin/request/action') }}" method="GET">

                    <div class="analytic">
                        <a href="{{ url('admin/request') }}" class="text-primary">All<span
                                class="text-muted">({{ $countItem }})</span></a>
                        <a href="{{ url('admin/request?status=trash') }}" class="text-primary">
                    ...
                    <table class="table table-striped table-checkall">
                        ...
                        <tbody>
                            ...
                            @foreach ($list_request as $request)
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="checkItem[]" value="{{ $request->id }}">
                                    </td>
                                    <td>{{ $t }}</td>
                                    ...
                                    <td style="display: flex; justify-content: space-between;">
                                        ...
                                        <div class="action-wp">
                                            @if ($trash == true)
                                                <a href="{{ url('admin/request/restore/' . $request->id) }}" class="action"
                                                    title="Restore">
                                            ...
                                            @if ($trash == true)
                                                <a href="{{ url('admin/request/forceDelete/' . $request->id) }}"
