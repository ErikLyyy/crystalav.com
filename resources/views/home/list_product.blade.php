...
@section('content')
    ...
    @else
        <p style="text-align: center; padding:20px;">We are updating this page. If you have any questions, please call
            866.441.6468 or <a href="{{ url('contact') }}" style="color:brown">contact us</a>.</p>
    @endif
