...
Route::prefix('/admin')->middleware('auth')->group(function () {
    ...
    Route::controller(AboutController::class)->prefix('/about')->group(function () {
        ...
        Route::get('/store', 'store')->name('about_store');
        Route::get('/edit/{id}', 'edit')->name('about_edit');
        Route::get('/update/{id}', 'update')->name('about_update');
    ...
    Route::controller(CategoriesController::class)->prefix('/categories')->group(function () {
        ...
        Route::get('/store', 'store')->name('categories_store');
        Route::get('/edit/{id}', 'edit')->name('categories_edit');
        Route::get('/update/{id}', 'update')->name('categories_update');
    ...
    Route::controller(SidebarController::class)->prefix('/sidebar')->group(function () {
        ...
        Route::get('/store', 'store')->name('sidebar_store');
        Route::get('/edit/{id}', 'edit')->name('sidebar_edit');
        Route::get('/update/{id}', 'update')->name('sidebar_update');
    ...
    Route::controller(ProductController::class)->prefix('/product')->group(function () {
        ...
        Route::get('/store', 'store')->name('product_store');
        Route::get('/edit/{id}', 'edit')->name('product_edit');
        Route::get('/update/{id}', 'update')->name('product_update');
    ...
    Route::controller(PermissionController::class)->prefix('/permission')->group(function () {
        ...
        Route::get('/store', 'store')->name('permission_store');
        Route::get('/edit/{id}', 'edit')->name('permission_edit');
        Route::get('/update/{id}', 'update')->name('permission_update');
